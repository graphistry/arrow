...
/** @ignore */
export declare type BuilderCtorArgs<T extends Builder<R, any>, R extends DataType = any, TArgs extends any[] = any[], TCtor extends new (type: R, ...args: TArgs) => T = new (type: R, ...args: TArgs) => T> = TCtor extends new (type: R, ...args: infer TArgs) => T ? TArgs : never;
/**
...
/** @ignore */
export declare type BuilderCtorType<T extends Builder<R, any>, R extends DataType = any, TCtor extends new (options: DataBuilderOptions<R, any>) => T = new (options: DataBuilderOptions<R, any>) => T> = TCtor extends new (options: DataBuilderOptions<R, any>) => T ? TCtor : never;
/** @ignore */
...
/** @ignore */
export declare type Builder<T extends Type | DataType = any, TNull = any> = T extends Type ? TypeToBuilder<T, TNull> : T extends DataType ? DataTypeToBuilder<T, TNull> : builders.Builder<any, TNull>;
/** @ignore */
...
/** @ignore */
export declare type BuilderCtor<T extends Type | DataType = any> = T extends Type ? BuilderCtorType<Builder<T>> : T extends DataType ? BuilderCtorType<Builder<T>> : BuilderCtorType<builders.Builder>;
/** @ignore */
