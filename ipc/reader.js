    ...
    open(autoClose = this.autoClose) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!this.closed) {
                this.autoClose = autoClose;
                try {
                    if (!(this.schema || (this.schema = (yield this.reader.readSchema(!autoClose))))) {
                        return this.close();
                    }
                }
                catch (e) {
